...
void Search(int [,] tempArray, int m, int n)
{
    if(m < tempArray.GetLength(0) && m >= 0 && n < tempArray.GetLength(1) && n >= 0)
    {
...
Search(array, userSearchStringNumber, userSearchColumnNumber);
